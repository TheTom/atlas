...
def permitted(baseline_used, used, available):
    # Keep 4 GB free-space headroom below the user's 70 GB / 12 GB limits.
    return used - baseline_used <= 65_000_000_000 and available >= 16_000_000_000


def selftest():
    assert permitted(100,100,20_000_000_000)
    assert not permitted(100,65_000_000_101,30_000_000_000)
    assert not permitted(100,100,15_999_999_999)
    assert permitted(100,65_000_000_100,16_000_000_000)
