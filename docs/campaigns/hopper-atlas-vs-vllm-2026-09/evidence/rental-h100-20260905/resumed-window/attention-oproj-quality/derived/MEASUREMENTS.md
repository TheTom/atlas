...
## Explicit quality-only sessions

- benchmark.qwen38.atlas.native-oproj-quality01: no ladder requested; observed request count=17; request oracle and command passed=True. Original coherency passed=False; separate exception permits continuation=True. Intent or cleanup markers alone do not prove quality success; no throughput or certification is inferred.
