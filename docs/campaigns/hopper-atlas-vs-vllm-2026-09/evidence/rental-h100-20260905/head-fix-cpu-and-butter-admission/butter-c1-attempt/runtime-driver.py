...
def main():
    ...
    ap.add_argument('--work-cap-s',type=int,default=270)
    args=ap.parse_args()
    red=selftest()
    ...
    absolute_end=datetime.datetime(2026,9,6,1,15,30,tzinfo=datetime.timezone.utc)
    ...
    out=ROOT/'results'/('butter-block-fp8-lat-c1-'+datetime.datetime.now(datetime.timezone.utc).strftime('%Y%m%dT%H%M%SZ'))
